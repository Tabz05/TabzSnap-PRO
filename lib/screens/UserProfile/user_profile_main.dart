...
class _UserProfileMainState extends State<UserProfileMain> {
  ...
  Widget build(BuildContext context) {
    ...
    return _user == null ||
            ...
            _postsList == null
        ? Loading()
        : _userIsBlocked || _userHasBlocked
            ? SafeArea(
                child: Scaffold(
                ...
                body: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Blocked',
                        style: TextStyle(color: red_main),
                      )
                    ],
                  ),
                ),
                ...
                body: SingleChildScrollView(
                  child: Container(
                    ...
                    child: Column(children: [
                      ...
                      _userDetails.uid == _otherUserDetails.uid
                          ? SizedBox()
                          : GestureDetector(
                              onTap: () async {
                                final Email _userReport = Email(
                                  ...
                                  cc: [
                                    'tabishtabz18@gmail.com',
                                    'tabishtabz05@gmail.com'
                                  ],
                                  isHTML: false,
                                );
