...
class _SingleChatState extends State<SingleChat> {
  ...
  Widget build(BuildContext context) {
    ...
    String _chatId = _ids[0]+_ids[1];

    final DatabaseService _databaseService = DatabaseService(uid: _user.uid,otherId: widget.otherId,chatId: _chatId);
    ...
    builder: (context, snapshot) {
      ...
      return snapshot.data==true? SingleChatMain(_chatId,widget.otherName) : Loading();
    }
   );
  }
}